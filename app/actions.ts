  ...
  const session = await stripe.checkout.sessions.create({
    ...
    success_url:
      process.env.NODE_ENV === "development"
        ...
        : "https://digitalmarket-seven.vercel.app/payment/success",
    cancel_url:
      process.env.NODE_ENV === "development"
        ? "http://localhost:3000/payment/cancel"
        : "https://digitalmarket-seven.vercel.app/payment/cancel",
  });
  ...
  const accountLink = await stripe.accountLinks.create({
    ...
    refresh_url:
      process.env.NODE_ENV === "development"
        ...
        : `https://digitalmarket-seven.vercel.app/billing`,
    return_url:
      process.env.NODE_ENV === "development"
        ? `http://localhost:3000/return/${data?.connectedAccountId}`
        : `https://digitalmarket-seven.vercel.app/return/${data?.connectedAccountId}`,
